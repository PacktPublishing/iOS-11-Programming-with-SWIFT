...
class EntryController {
    ...
    init() {
        let entry1 = Entry(title: "My first Entry", body: "This is my first entry", tag: "Journal", color: .lightGray)
        let entry2 = Entry(title: "Another Entry", body: "Here is another entry for my Journal. This entry will have some additional text to be able to demonstrate setting dynamic tableview cell heights using the tableviewdelegate methods.", tag: "Journal", color: .lightGray)
        let entry3 = Entry(title: "Yet another Entry", body: "The body for another entry in my journal", tag: "Journal", color: .lightGray)
        let entry4 = Entry(title: "One more Entry", body: "This is the last entry for my journal for today", tag: "journal", color: .lightGray)
